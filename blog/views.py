...
#     recent_posts = ArticleModel.objects.all().order_by('-created_at')[:6] replace
#     categories = CategoryModel.objects.all()[:6]
#     blogs = ArticleModel.objects.all()[:4]  replace
...
#     blogs = ArticleModel.objects.all() replace
